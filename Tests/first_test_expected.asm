...
add	rsp,	240
mov	rbx,	[rsp]
mov	qword	[rsp-264],	s10
mov	qword	[rsp-256],	23
lea	rax,	[rsp-248]
mov	[rsp-272],	rax
lea	rbx,	[rsp-248]
lea	rax,	[rel+f14]
